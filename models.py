...
class Measurement(db.Model):
    ...
    soil_A_moisture = db.Column(db.Float, unique=False, nullable=False)
    soil_B_moisture = db.Column(db.Float, unique=False, nullable=False)
    brightness = db.Column(db.Float, unique=False, default=0)
    wateringtime_A = db.Column(db.Float, unique=False, default=0)
    wateringtime_B = db.Column(db.Float, unique=False, default=0)
